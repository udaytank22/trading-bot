...
export const confirmAction = async ({
  ...
  const result = await Swal.fire({
    ...
    customClass: {
      ...
      confirmButton: `px-6 py-2.5 rounded-xl font-bold shadow-md transition-all border-none focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-[#1a1d23] ${
        isDanger 
