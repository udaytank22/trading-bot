  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-[#1a1d23] border border-[#2a2d33] rounded-2xl w-full max-w-5xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="px-8 py-5 border-b border-[#2a2d33] flex justify-between items-center bg-[#1a1d23]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Total Quantity</label>
                <div className="w-full px-4 py-2.5 bg-[#0c0e12]/30 border border-[#2a2d33] rounded-lg text-sm text-gray-400 font-mono italic">
                  {formData.totalQty || "0.00"}
                </div>
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Grn Status</label>
                <input
                  type="text"
                  name="grnStatus"
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Taxes</label>
                <input
                  type="text"
                  name="taxes"
                  ...
                  onChange={handleChange}
                  className="w-full bg-[#0c0e12] border border-[#2a2d33] rounded-lg px-4 py-2.5 text-sm text-white outline-none focus:border-purple-500/50 transition-all placeholder:text-gray-700 hover:bg-[#14171c]"
                />
              </div>
              <div className="flex flex-col gap-2">
              ...
              <div className="pt-4">
                ...
                <div className="relative group">
                  ...
                  />
                  <div className={`w-full border-2 border-dashed rounded-xl px-5 py-6 transition-all flex flex-col items-center gap-3 text-center ${
                    formData.attachment 
                      ? "bg-purple-600/5 border-purple-500/40 text-purple-400 shadow-inner" 
                      : "bg-[#0c0e12]/40 border-[#2a2d33] text-gray-600 group-hover:border-purple-500/30 group-hover:bg-purple-600/[0.02]"
                  }`}>
                    <div className={`p-2.5 rounded-xl ${formData.attachment ? "bg-purple-600/20" : "bg-white/5"}`}>
                      <svg className={`w-6 h-6 ${formData.attachment ? "text-purple-400" : "text-gray-500"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                      </svg>
                    </div>
                    <div className="space-y-1">
                      <span className="block text-[11px] font-bold uppercase tracking-wider">{formData.attachment ? formData.attachment.name : "Click to upload PO"}</span>
                      {!formData.attachment && <span className="block text-[9px] text-gray-500 uppercase tracking-widest">PDF, PNG, JPG (Max 10MB)</span>}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-end pt-6">
              <div className="w-80 space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Gross Purchase Amount:</span>
                  <span className="text-white font-mono">₹ 0.00</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Discount Received Amount:</span>
                  <span className="text-white font-mono">₹ 0.00</span>
                </div>
                <div className="flex justify-between text-sm border-b border-[#2a2d33] pb-3">
                  <span className="text-gray-500">Purchase Amount Net of Discount:</span>
                  <span className="text-white font-mono">₹ 0.00</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-lg font-bold pt-2 border-t border-[#2a2d33]">
                  <span className="text-white">Net Total:</span>
                  <span className="text-purple-400 font-mono">₹ 0.00</span>
                </div>
              </div>
            </div>
          </div>
