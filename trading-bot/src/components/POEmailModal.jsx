  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <div
        ...
        onClick={() => { if (sendState === 'idle' && !showPdf) onClose(); }}
      />

      {/* Modal Container */}
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-gray-50 dark:bg-[#1a1d23] border border-gray-200 dark:border-[#2a2d33] rounded-2xl shadow-2xl flex flex-col z-10 animate-in zoom-in-95 duration-200 overflow-hidden">
        ...
        {sendState === 'success' ? (
          <div className="flex flex-col items-center justify-center p-16 h-full text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Email Sent Successfully!</h2>
        ...
        /* ── EMAIL COMPOSE VIEW ── */
          ...
          <>
            ...
            <div className="px-6 py-4 border-b border-gray-200 dark:border-[#2a2d33] flex justify-between items-center bg-gray-50 dark:bg-[#1a1d23] flex-shrink-0">
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">Send Purchase Order by Email</h2>
              ...
              <div className={`bg-white rounded-xl p-8 text-gray-800 shadow-sm border-2 ${isEditing ? 'border-purple-500 shadow-purple-500/10' : 'border-transparent'}`}>
                ...
                <div className="space-y-2 mb-6 pb-4 border-b border-gray-100">
                  <div className="flex text-sm">
                    <span className="w-20 text-gray-400 font-bold uppercase text-[10px] py-1">To:</span>
                    <span className="font-bold">{po.customer} &lt;{po.customer.toLowerCase().replace(/\s/g, '.')}@trademind.com&gt;</span>
                  </div>
                  <div className="flex text-sm">
                    <span className="w-20 text-gray-400 font-bold uppercase text-[10px] py-1">Subject:</span>
                    <span className="font-bold">Official Purchase Order - {po.po_id}</span>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pr-2">
                      <p className="text-[12px] font-bold text-gray-700 group-hover:text-purple-600 transition-colors">{po.po_id}_Document.pdf</p>
                      <p className="text-[10px] text-gray-500 uppercase tracking-widest">150 KB • PDF Document</p>
                    </div>
