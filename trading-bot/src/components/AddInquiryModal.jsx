      ...
      >
        ...
        <div className="px-8 py-5 border-b border-[#2a2d36] flex justify-between items-center bg-[#1a1d23] flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-white tracking-tight">Create New Inquiry</h2>
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mt-0.5">Sourcing Request</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-y-8">
            <div className="space-y-6">
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Customer</label>
                <select
                  name="customer"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Currency</label>
                  <select
                    name="currency"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Validity Date</label>
                  <input
                    type="date"
                    name="validityDate"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Request Type</label>
                  <select
                    name="requestType"
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Salesperson</label>
                  <input
                    type="text"
                    name="salesperson"
              ...
              <div className="relative group">
                ...
                <div className={`w-full border-2 border-dashed rounded-xl px-5 py-4 transition-all flex items-center justify-between ${formData.attachment
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[11px] font-bold uppercase tracking-wider truncate max-w-[200px]">{formData.attachment ? formData.attachment.name : "Upload Inquiry File"}</span>
                  </div>
