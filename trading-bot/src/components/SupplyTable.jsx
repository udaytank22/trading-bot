    ...
    <div className="w-full overflow-hidden flex flex-col h-full">
      <div className="w-full overflow-x-auto overflow-y-auto max-h-[600px] custom-scrollbar">
        <table className="w-full text-left text-sm table-auto border-separate border-spacing-0">
          <thead className="bg-[#242830] text-gray-400 text-[11px] font-bold uppercase tracking-wider border-b border-[#2a2d33] sticky top-0 z-10 backdrop-blur-md">
            <tr>
              <th className="px-4 md:px-6 py-4 border-b border-[#2a2d33]">
                Cargo ID
              </th>
              <th className="px-4 md:px-6 py-4 border-b border-[#2a2d33]">
                Supplier
              ...
              <th className="px-4 md:px-6 py-4 hidden md:table-cell border-b border-[#2a2d33]">
                Quantity
              </th>
              <th className="px-4 md:px-6 py-4 hidden lg:table-cell border-b border-[#2a2d33]">
                Destination
              </th>
              <th className="px-4 md:px-6 py-4 border-b border-[#2a2d33]">
                Status
              </th>
              <th className="px-4 md:px-6 py-4 text-right border-b border-[#2a2d33]">
                Actions
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-4 md:px-6 py-4">
                  <div className="flex flex-col md:flex-row justify-end gap-2">
                    ...
                    <Tooltip content="Contact Logistics">
                      <button
