      ...
      >
        {po && (
          <div className="flex flex-col h-full">
            {/* Header */}
            <div className="p-8 border-b border-[#2a2d36] bg-[#1a1d23]/50 relative">
              <button
                onClick={onClose}
              ...
              <h2 className="text-2xl font-bold text-white tracking-tight mb-1">{po.customer}</h2>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-10 custom-scrollbar">
              ...
              <div className="space-y-4">
                ...
                <div className="overflow-hidden border border-[#2a2d36] rounded-xl bg-[#0c0e12]/30">
                  <table className="w-full text-left text-sm">
                    <thead>
                      <tr className="bg-[#0c0e12]/50 text-gray-400 text-[10px] uppercase tracking-widest border-b border-[#2a2d36]">
                    ...
                    <tbody className="divide-y divide-[#2a2d36]/50">
                      {po.products.map((p, i) => (
                        <tr key={i} className="hover:bg-white/[0.02] transition-colors">
                          <td className="px-5 py-4 text-white font-medium">{p.product_name}</td>
              ...
              {/* Transaction Summary */}
              <div className="space-y-4 pt-4 border-t border-[#2a2d36]">
                <h3 className="text-[11px] font-bold text-gray-500 uppercase tracking-[0.2em] mb-4">Financial Summary</h3>
                <div className="grid grid-cols-1 gap-4 bg-[#0c0e12]/30 p-5 rounded-2xl border border-[#2a2d36]">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400 text-sm">Total Amount</span>
                    <span className="text-white font-bold font-mono text-lg">{formatINR(po.total_amount || 0)}</span>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 ml-2">
                  <div className="flex gap-4 items-start relative pb-6 border-l-2 border-purple-500/20 pl-6">
                    ...
                    <div>
                      <p className="text-white text-sm font-bold">PO Created</p>
                      <p className="text-gray-500 text-xs mt-1">Transaction initiated by System</p>
                    </div>
                  </div>
                  <div className="flex gap-4 items-start pl-6">
                    <div className="w-4 h-4 rounded-full border-2 border-gray-700 bg-[#1e2028] ml-[-9px]" />
                    <div>
            ...
            {/* Footer */}
            <div className="p-8 border-t border-[#2a2d36] bg-[#1a1d23] flex gap-4">
              <button
                onClick={onClose}
                className="flex-1 py-3 px-6 rounded-xl bg-white/[0.05] border border-[#2a2d36] text-gray-300 font-bold text-sm hover:bg-white/10 transition-all active:scale-95"
              >
                Close View
              </button>
