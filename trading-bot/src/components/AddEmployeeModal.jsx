...
const ROLES = ["Admin", "Sales Executive", "Sourcing Manager", "Accountant", "Logistics Coordinator", "HR Manager"];

export default function AddEmployeeModal({ isOpen, onClose, onSubmit, employeeToEdit }) {
        ...
        <div className="px-8 py-5 border-b border-[#2a2d36] flex justify-between items-center bg-[#1a1d23] flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mt-0.5">Staff Management</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Joining Date</label>
                <input
                  type="date"
                  name="joiningDate"
              ...
              <div className="flex gap-4">
                {["Active", "Inactive"].map(s => (
                  <label key={s} className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className={`text-sm font-medium ${formData.status === s ? "text-white" : "text-gray-500"} transition-colors`}>{s}</span>
                  </label>
                ))}
              </div>
            </div>
          ...
          <div className="bg-purple-600/5 border border-purple-500/10 rounded-2xl p-6">
            ...
            <p className="text-[11px] text-gray-500 leading-relaxed mb-4">
              Employees will use their work email and a default password to login. Password resets can be initiated from the admin panel.
            </p>
            <div className="flex flex-col gap-2 opacity-60">
              <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Access Level</label>
