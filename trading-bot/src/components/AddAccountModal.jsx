...
export default function AddAccountModal({ isOpen, onClose, onSubmit, accountToEdit }) {
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-[#2a2d36] flex justify-between items-center bg-[#1a1d23] flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] mt-0.5">Financial Details</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Bank Name</label>
            <input
              type="text"
              name="bankName"
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Account Purpose / Name</label>
            <input
              type="text"
              name="accountName"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Account Number</label>
              <input
                type="text"
                name="accountNumber"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Routing / SWIFT</label>
              <input
                type="text"
                name="routingNumber"
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em] ml-1">Current Balance</label>
