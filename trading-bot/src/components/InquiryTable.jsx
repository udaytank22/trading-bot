              ...
              >
                    ...
                    <Tooltip
                      content={
                        inq.products.length > 1
                          ? inq.products.map((p) => p.product_name).join(", ")
                ...
                <td className="px-3 md:px-6 py-4">
                  <div className="flex flex-col md:flex-row items-end justify-end gap-2">
                    ...
                    <Tooltip content="Send RFQ to Suppliers">
                      <button
                    ...
                    <Tooltip content="Send Quote to Buyer">
                      <button
                        onClick={() => onSendQuote(inq)}
                    ...
                    <Tooltip content="Confirm and Move to Supply">
                      <button
                        onClick={() => onSendQuote(inq)}
