...
import { Shield, ShieldAlert, Lock, RotateCcw, Check, CheckSquare, Search } from 'lucide-react';
...
function PermissionSwitch({ checked, onChange, disabled }) {
  return (
    <button
      ...
      disabled={disabled}
      onClick={onChange}
      className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500/30 disabled:opacity-60 disabled:cursor-not-allowed ${
        checked 
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center gap-2">
                    <div className={`p-2 rounded-lg ${
                      role === "Super Admin" ? "bg-purple-50 text-purple-600 dark:bg-purple-950/30 dark:text-purple-400" :
