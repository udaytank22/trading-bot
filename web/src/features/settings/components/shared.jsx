...
export function HeaderButton({ onClick, icon, children, color = 'gray', className = '' }) {
  const colorCls = {
    gray: "bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300",
    emerald: "bg-emerald-600 hover:bg-emerald-500 text-white",
    purple: "bg-purple-600 hover:bg-purple-500 text-white"
  }[color] || "bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300";
