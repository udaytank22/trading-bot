  ...
  return (
    <div className="flex flex-col w-full h-full pb-4 gap-4 animate-in fade-in duration-700">
      ...
      {closedDeals.length > 0 && (
        <section className="bg-white dark:bg-[#161922] border border-gray-200 dark:border-white/10 rounded-xl shadow-sm overflow-hidden flex-1 flex flex-col min-h-0 mt-4">
